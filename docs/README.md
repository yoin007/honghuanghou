...
| [auth-system-blueprint.md](auth-system-blueprint.md) | 当前统一鉴权体系总图，说明 API 权限、记录范围、目标范围和动作范围 |
| [auth-frontend-adaptation-plan.md](auth-frontend-adaptation-plan.md) | 权限配置前端页面设计与当前落地状态 |
| [unified-permission-optimization-plan.md](unified-permission-optimization-plan.md) | 统一权限配置收口方案与已完成事项 |
| [legacy-auth-unification-migration-plan.md](legacy-auth-unification-migration-plan.md) | 教师管理、文件收集、旧版作业/请假/课表、监考安排和 moral 辅助接口的统一鉴权迁移计划 |
| [teacher-todo-feature-plan.md](teacher-todo-feature-plan.md) | 教师待办功能实施方案，供其他 AI 直接据此完成前后端开发 |
...
5. 权限治理优先读 [auth-system-blueprint.md](auth-system-blueprint.md)、[auth-frontend-adaptation-plan.md](auth-frontend-adaptation-plan.md) 和 [unified-permission-optimization-plan.md](unified-permission-optimization-plan.md)。
6. 德育相关读 [moral-evaluation-system.md](moral-evaluation-system.md) 和 [moral-config-guide.md](moral-config-guide.md)。
7. 旧模块统一鉴权迁移读 [legacy-auth-unification-migration-plan.md](legacy-auth-unification-migration-plan.md)。
8. 教师待办功能实现读 [teacher-todo-feature-plan.md](teacher-todo-feature-plan.md)。
9. 监考、驾驶舱、数据库合并和 HTTPS 部署按专题阅读对应文档。
...
- 2026-05-13：补齐统一权限体系三份核心文档索引，当前权限巡检为 `174` 条 API、`0` 条风险，后端全量测试 `608 passed`。
- 2026-05-13：新增 `legacy-auth-unification-migration-plan.md`，明确暂缓迁移模块的统一鉴权实施路径。
- 2026-05-13：新增 `teacher-todo-feature-plan.md`，形成“我的待办”模块的可执行实施方案。
- 已合并并删除历史草案：
  - `德育评价系统设计方案.md`
  - `德育评价系统合并方案.md`
  - `德育评价系统合并实施计划.md`
